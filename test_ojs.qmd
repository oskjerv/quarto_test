...
I dette eksempelet er det lastet inn data fra SSB. Ved å bruke menyvelgerne kan man selektere hvilken aldersgruppe man ønsker å visualisere, og hvilke kommuner som skal inngå i sammenligningen.
...
filtered_averages = transpose(data_averages).filter(function(komm) {
  return kommuner.includes(komm.kommnavn);
})
